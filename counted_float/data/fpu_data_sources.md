...
Itanium, Transmeta, IBM Power... chips can be considered either obsolete or sufficiently niche. 
...
The table below provides additional references that can be used to obtain more background data or check original sources of data found in the relevant paths.
(paths are relative to the `data` folder.)

| path | name                                                                               | author               | url                                                                                 | retrieved at |
|------|------------------------------------------------------------------------------------|----------------------|-------------------------------------------------------------------------------------|--------------|
...
| todo | Instruction Tables                                                                 | Agner Fog            | https://www.agner.org/optimize/instruction_tables.pdf                               | 2025-09-13   |
| todo | Cortex A55 Software Optimization Guide v4                                          | Arm Ltd.             | https://developer.arm.com/documentation/EPM128372/latest/                           | 2025-09-14   |
| todo | Cortex A76 Software Optimization Guide                                             | Arm Ltd.             | https://developer.arm.com/documentation/PJDOC-466751330-7215/latest/                | 2025-09-14   |
| todo | Cortex X1 Software Optimization Guide                                              | Arm Ltd.             | https://developer.arm.com/documentation/102174/latest/                              | 2025-09-14   |
| todo | Cortex X2 Software Optimization Guide                                              | Arm Ltd.             | https://developer.arm.com/documentation/PJDOC-466751330-14955/latest/               | 2025-09-14   |
| todo | Cortex X3 Software Optimization Guide                                              | Arm Ltd.             | https://developer.arm.com/documentation/PJDOC-466751330-590747/r1p2                 | 2025-09-14   |
