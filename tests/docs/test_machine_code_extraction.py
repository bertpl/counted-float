"""The machine-code extraction must find the right loops and canonicalize them deterministically."""
...
sys.modules[_spec.name] = generate_machine_code_docs
_spec.loader.exec_module(generate_machine_code_docs)

best_matching_loops = generate_machine_code_docs.best_matching_loops
canonicalize_loop = generate_machine_code_docs.canonicalize_loop
innermost_loops = generate_machine_code_docs.innermost_loops
native_function_body = generate_machine_code_docs.native_function_body
...
def test_machine_code_pages_cover_every_benchmarked_flop_type():
    # --- arrange -----------------------------------------
    from counted_float._core.models import FlopType

    # F2I / I2F have no benchmark probes (their weights come from spec sheets and third-party
    ...
    # --- act ---------------------------------------------
    page_names = {page.doc_name for page in generate_machine_code_docs.PAGES}
