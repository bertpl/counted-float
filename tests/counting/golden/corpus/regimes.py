...
ROWS: list[CorpusRow] = flat([
    ...
    row("A3",  "round(num(2.7))",                                  {"F2I": 1},               int,          R_ENDINGS),
    row("A3",  "num(1.0) < 2.0",                                   {"COMP": 1},              bool,         R_ENDINGS),
    ...
    row("A10", "num(1.5) == Decimal('1.5')",                        {},                       bool,         R_SCOPE),
    row("A10", "num(1.5) < Decimal('2.5')",                         {},                       bool,         R_SCOPE),
    ...
    row("A16", "num(1.0) + 1j",                                    {},                       complex,      R_ENDINGS),
    row("A16", "num(1.0) * (2 + 3j)",                              {},                       complex,      R_ENDINGS),
    row("A17", "num(1.0) == 1j",                                   {},                       bool,         R_ENDINGS),
    row("A17", "num(1.0) == (1 + 0j)",                             {},                       bool,         R_ENDINGS),
    ...
    row("A14", "num(1.0) + np.float64(2.0)",                        {"ADD": 1},               CF,           R_SCOPE, requires="numpy", plain_parity=False, probe=_NUMPY_FLOAT64_LEFT),
    row("A14", "np.float64(2.0) + num(1.0)",                        {"ADD": 1},               CF,           R_SCOPE, requires="numpy", plain_parity=False, probe=_NUMPY_FLOAT64_RIGHT),
