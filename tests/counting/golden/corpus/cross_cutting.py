...
ROWS: list[CorpusRow] = flat([
    ...
    row("A4",  "math.prod([num(2.0), num(3.0), None])",            {},                       None,         R_RECORDS, I_LOOPS, raises=TypeError),
    row("A4",  "math.prod([num(2.0), None])",                      {},                       None,         R_RECORDS, I_LOOPS, raises=TypeError),
    ...
    row("A15", "num(1.0) < 1j",                                    {},                       None,         R_ENDINGS, raises=TypeError),
    row("A16", "math.comb(num(4.0), 2)",                           {},                       None,         R_SCOPE, raises=TypeError),
    row("A16", "math.factorial(num(4.0))",                         {},                       None,         R_SCOPE, raises=TypeError),
    row("A16", "math.gcd(num(4.0), 2)",                            {},                       None,         R_SCOPE, raises=TypeError),
    row("A16", "math.isqrt(num(4.0))",                             {},                       None,         R_SCOPE, raises=TypeError),
