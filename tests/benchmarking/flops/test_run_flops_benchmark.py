...
from counted_float._core.benchmarking.flops import flops_benchmark_suite
...
def test_run_flops_benchmark_warns_when_cpu_freq_unavailable(monkeypatch):
    ...
    # --- arrange ----------------------
    monkeypatch.setattr(flops_benchmark_suite, "get_cpu_frequency_mhz_current", lambda: None)
...
def test_run_flops_benchmark_no_freq_warning_when_available(monkeypatch, recwarn):
    ...
    # --- arrange ----------------------
    monkeypatch.setattr(flops_benchmark_suite, "get_cpu_frequency_mhz_current", lambda: 3000.0)
