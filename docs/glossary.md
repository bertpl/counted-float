...
to do. See
[Cost-model rules](cost_model_rules.md#how-the-port-is-built) for the full story.
...
function normally performs, not its shortcut ([cost-model rule 4](cost_model_rules.md#the-rules)).
...
[cost-model rule 1](cost_model_rules.md#the-rules).
