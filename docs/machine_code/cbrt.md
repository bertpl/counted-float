...
<!-- BEGIN generated: machine-code-cbrt-diff -->
```diff
--- f_add
+++ f_add_cbrt
  .L0:
...
+ subs  %x4, %x4, #1
  b.ne  .L0
```
<!-- END generated: machine-code-cbrt-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-cbrt-structure -->
...
??? note "Full ASM listing: `f_add_cbrt`"
    ...
    LBB0_6:
      ...
      .cfi_endproc
    ```
<!-- END generated: machine-code-cbrt-structure -->
