...
The `ERFC` cost is the latency difference between a probe chaining `math.erfc(tmp + x[i])` and
...
+ subs  %x3, %x3, #1
  b.ne  .L0
```
<!-- END generated: machine-code-erfc-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-erfc-structure -->
...
??? note "Full ASM listing: `f_add_erfc`"
    ...
    ```
<!-- END generated: machine-code-erfc-structure -->
