...
+ cmp  %x6, %x2
  b.ne  .L0
```
<!-- END generated: machine-code-hypot-xarg-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-hypot-xarg-structure -->
...
??? note "Full ASM listing: `f_add_hypot_scaled8`"
    ...
    Lloh5:
      ...
      .cfi_endproc
    ```
<!-- END generated: machine-code-hypot-xarg-structure -->
...
3. *Loop-structure symmetry*: neither probe unrolls (the bodies are large enough that LLVM
   leaves them alone). Each probe compiles to two variants of its loop with an identical
