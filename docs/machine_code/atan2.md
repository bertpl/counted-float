...
<!-- BEGIN generated: machine-code-atan2-diff -->
```diff
--- f_add
+++ f_add_atan2
  .L0:
...
+ cmp  %x4, %x3
  b.ne  .L0
```
<!-- END generated: machine-code-atan2-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-atan2-structure -->
...
??? note "Full ASM listing: `f_add_atan2`"
    ...
    ```
<!-- END generated: machine-code-atan2-structure -->
