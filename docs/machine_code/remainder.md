...
+ subs  %x4, %x4, #1
  b.ne  .L0
```
<!-- END generated: machine-code-remainder-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-remainder-structure -->
...
??? note "Full ASM listing: `f_add_remainder`"
    ...
    LBB0_6:
      ...
      .cfi_endproc
    ```
<!-- END generated: machine-code-remainder-structure -->
...
1. *Intended call, and nothing else*: the structural additions are the `blr` — the `remainder`
   ...
   ctypes closure (the other libm probes keep their target in a register; the ctypes route
