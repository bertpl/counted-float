...
The `ERF` cost is the latency difference between a probe chaining `math.erf(tmp + x[i])` and
...
+ subs  %x3, %x3, #1
  b.ne  .L0
```
<!-- END generated: machine-code-erf-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-erf-structure -->
...
??? note "Full ASM listing: `f_add_erf`"
    ...
    ```
<!-- END generated: machine-code-erf-structure -->
