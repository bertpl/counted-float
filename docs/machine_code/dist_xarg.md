...
+ b.eq  .L0
```
<!-- END generated: machine-code-dist-xarg-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-dist-xarg-structure -->
...
??? note "Full ASM listing: `f_add_dist8`"
    ...
    Lloh5:
      ...
      .cfi_endproc
    ```
<!-- END generated: machine-code-dist-xarg-structure -->
...
3. *Loop-structure symmetry*: neither probe unrolls; both carry the same zero-guard, whose
