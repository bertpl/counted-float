...
<!-- BEGIN generated: machine-code-sin-diff -->
```diff
--- f_add
+++ f_add_sin
  .L0:
...
+ subs  %x3, %x3, #1
  b.ne  .L0
```
<!-- END generated: machine-code-sin-diff -->

## Loop structure

<!-- BEGIN generated: machine-code-sin-structure -->
...
??? note "Full ASM listing: `f_add_sin`"
    ...
    ```
<!-- END generated: machine-code-sin-structure -->
